...
namespace miniorangedev\craftsinglesignon\fields;

use miniorangedev\craftsinglesignon\Craftsinglesignon;
use miniorangedev\craftsinglesignon\assetbundles\optionfield\OptionFieldAsset;
...
class Option extends Field
{
    ...
    {
        return Craft::t('craft-single-sign-on', 'Option');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-single-sign-on/_components/fields/Option_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(OptionFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CraftsinglesignonOption(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'craft-single-sign-on/_components/fields/Option_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

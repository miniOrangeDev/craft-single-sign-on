...
namespace miniorangedev\craftsinglesignon\widgets;

use miniorangedev\craftsinglesignon\Craftsinglesignon;
use miniorangedev\craftsinglesignon\assetbundles\settingswidget\SettingsWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * craft-single-sign-on Widget
 *
...
class Settings extends Widget
{
    ...
    {
        return Craft::t('craft-single-sign-on', 'Settings');
    }
    ...
    {
        return Craft::getAlias("@miniorangedev/craftsinglesignon/assetbundles/settingswidget/dist/img/Settings-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'craft-single-sign-on/_components/widgets/Settings_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(SettingsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'craft-single-sign-on/_components/widgets/Settings_body',
            [

...
class LoginController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(isset($_GET['test_config'])){
            ...
            $db_update = Craft::$app->db->createCommand()->update($prefix.'mologin_config', ['options' => json_encode($alldata)], ['name' => $site_name])->execute();
        }
    ...
    public function actionCallback()
    {
        ...
        if(isset($user_info)){
            $var = Craft::$app->getUser()->login($user_info[0]); 

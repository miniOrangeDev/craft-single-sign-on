...
class Craftsinglesignon extends Plugin
{
    ...
    public function init(): void
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['craft-single-sign-on'] = 'craft-single-sign-on/settings/oauthsettings';
 ...
 */
    ...
    public function getCpNavItem(): ?array
    {
        ...
        $item['badgeCount'] = 5;
        $item['subnav'] = [
            'oauth_provider' => ['label' => 'OAuth Provider', 'url' => 'craft-single-sign-on/oauth-settings'],
            // 'saml_provider' => ['label' => 'SAML Provider', 'url' => 'craft-single-sign-on/saml-settings'],
        ];
        return $item;
    }
}
